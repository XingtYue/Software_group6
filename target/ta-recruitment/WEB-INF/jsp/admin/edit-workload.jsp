...
<%@ page import="java.util.List, java.util.Map, com.ta.recruitment.model.User" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<<<<<<< Updated upstream:target/ta-recruitment/WEB-INF/jsp/admin/edit-workload.jsp
            <!-- 返回按钮 -->
...
>>>>>>> Stashed changes:src/main/webapp/WEB-INF/jsp/admin/edit-workload.jsp
                </div>
