...
<div class="page-wrapper">
  ...
  <div class="nav-main-row">
    <a href="${pageContext.request.contextPath}/admin" class="nav-link">Users</a>
    <a href="${pageContext.request.contextPath}/admin/jobs" class="nav-link">Jobs</a>
    <a href="${pageContext.request.contextPath}/admin/applications" class="nav-link">Applications</a>
    <a href="${pageContext.request.contextPath}/admin/workload" class="nav-link">Workload</a>
    <a href="${pageContext.request.contextPath}/admin/profile" class="nav-link active">Profile</a>
  </div>
  ...
  <main class="main-content" style="overflow-y:auto;">
    <div style="max-width:720px;margin:0 auto;padding:24px;">
      ...
      <p class="text-sm text-gray-600" style="margin-bottom:20px;">Role: Administrator</p>
        ...
        <div class="card" style="padding:20px;">
          ...
          <form action="${pageContext.request.contextPath}/admin/profile" method="post">
            ...
            <div class="form-group">
              ...
              <input class="form-input" type="text" value="Administrator" disabled>
            </div>
